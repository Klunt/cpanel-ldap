...
if(isset($_POST['user']) && isset($_POST['usermail'])){
    ...
    if ($username != $adminname || $to != $adminmail){
        ...
        {
          $error='';
          $messagesent= "<div class='alert alert-success'><h4>" . sprintf (_("Se ha enviado un correo electrónico a la cuenta de correo %s . Por favor, revisa tu bandeja de entrada y sigue las instruccones que encontrarás en el mensaje"), $to)." </div>";
        } 
    } else {
